...
_get_delete_function(T) = getproperty(LibWasm, Symbol(string(nameof(T))[1:end-6] * "_vec_delete"))
_get_uninitialized_function(T) = getproperty(LibWasm, Symbol(string(nameof(T))[1:end-6] * "_vec_new_uninitialized"))
